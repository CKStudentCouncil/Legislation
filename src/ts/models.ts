...
export class DocumentSpecificIdentity {
  ...
  static GeneralIT = new DocumentSpecificIdentity('GeneralIT', '資訊股', '資', '08', DocumentGeneralIdentity.ExecutiveDepartment, '資訊股股長');
  ...
  static VALUES = {
    ...
    GeneralIT: DocumentSpecificIdentity.GeneralIT,
