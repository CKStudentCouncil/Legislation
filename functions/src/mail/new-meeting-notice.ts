...
<p style="margin: 0; word-break: break-word;"><span style="word-break: break-word; color: #003188;"><strong><a href="https://bqsc-legislation.firebaseapp.com/document/${id}" rel="noopener" style="text-decoration: underline; color: #bb9765;" target="_blank"><span style="word-break: break-word; color: #003188;"><strong>您收到了開會通知單</strong></span></a></strong></span></p>
</div>
</td>
</tr>
</table>
...
<p style="margin: 0; word-break: break-word;"><span style="word-break: break-word; color: #003188;">${user} 您好，</span></p>
</div>
</td>
</tr>
</table>
...
<p style="margin: 0; word-break: break-word;"><span style="word-break: break-word; color: #003188;">您收到了來自${from}的開會通知單，會議名稱「${subject}」。</span></p>
<p style="margin: 0; word-break: break-word;"><span style="word-break: break-word; color: #003188;">會議時間：民國${date.getFullYear() - 1911}年${date.getMonth() + 1}月${date.getDate()}日 星期${convertToChineseDay(date.getDay())} ${date.getHours() + 8}時 ${date.getMinutes()}分</span></p>
<p style="margin: 0; word-break: break-word;"><span style="word-break: break-word; color: #003188;">會議地點：${location}</span></p>
<p style="margin: 0; word-break: break-word;"><span style="word-break: break-word; color: #003188;">煩請出席及列席人準時與會。</span></p>
</div>
</td>
</tr>
</table>
...
<div style="color:#555555;font-family:Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:16px;font-weight:700;line-height:150%;text-align:left;mso-line-height-alt:24px;">
<p style="margin: 0; word-break: break-word;"><span style="word-break: break-word; color: #003188;">若要檢視會議內容及關係文書附件，請至<a href="https://bqsc-legislation.firebaseapp.com/document/${id}" rel="noopener" style="text-decoration: underline; color: #0068A5;" target="_blank">本會法律與公文系統</a>查閱。</span></p>
</div>
</td>
</tr>
</table>
...
<tr>
<td class="pad">
<div align="center" class="alignment"><a href="https://bqsc-legislation.firebaseapp.com/document/${id}" style="color:#000000;text-decoration:none;" target="_blank"><!--[if mso]>
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word"  href="https://bqsc-legislation.firebaseapp.com/document/${id}"  style="height:42px;width:152px;v-text-anchor:middle;" arcsize="10%" fillcolor="#bb9765">
