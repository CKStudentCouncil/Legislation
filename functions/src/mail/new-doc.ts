...
<p style="margin: 0; word-break: break-word;"><span style="word-break: break-word; color: #003188;">您收到了一封來自${from}的新公文，主旨「${subject}」。</span></p>
</div>
</td>
</tr>
</table>
...
<div style="color:#555555;font-family:Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:16px;font-weight:700;line-height:150%;text-align:left;mso-line-height-alt:24px;">
<p style="margin: 0; word-break: break-word;"><span style="word-break: break-word; color: #003188;">若要檢視其內容，請至<a href="https://bqsc-legislation.firebaseapp.com/document/${id}" rel="noopener" style="text-decoration: underline; color: #0068A5;" target="_blank">本會法律與公文系統</a>查閱。</span></p>
</div>
</td>
</tr>
</table>
